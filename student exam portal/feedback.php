...
<div class="col-md-10">
<a href="kavtikwaromkar@gmail.com" style="color:#000000">kavtikwaromkar@gmail.com</a><br /><br />
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="col-md-4">
		 ...
		 <div class="col-md-5">
		<a href="http://yugeshverma.blogspot.in" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Omkar Kavtikwar</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 8308940982</h4>
		<h4 style="font-family:'typo' ">kavtikwaromkar@gmail.com</h4>
		<h4 style="font-family:'typo' ">Gramin college of engineering,nandeds</h4></div></div>
		</p>
      </div>
